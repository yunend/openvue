  ...
  <nav class="w-full nav-bg">
    <section class="h-20 w-10/12 mx-auto font-mono nav-text flex items-center gap-x-3">
      ...
      <ul class="hidden md:flex gap-x-5 mx-3 items-center">
        <li><router-link class="block p-3 hover:bg-white/20" to="/">{{ t('nav.home') }}</router-link></li>
        <li><router-link class="block p-3 hover:bg-white/20" to="/upload">{{ t('nav.upload') }}</router-link></li>
      </ul>
    ...
    >
      <ul class="h-full my-5 w-10/12 mx-auto nav-text flex-col">
        ...
        <li><router-link class="block p-3 hover:bg-white/20 duration-300" to="/" @click="$emit('close-menu')">{{ t('nav.home') }}</router-link></li>
        <li><router-link class="block p-3 hover:bg-white/20 duration-300" to="/upload" @click="$emit('close-menu')">{{ t('nav.upload') }}</router-link></li>
        <li 
